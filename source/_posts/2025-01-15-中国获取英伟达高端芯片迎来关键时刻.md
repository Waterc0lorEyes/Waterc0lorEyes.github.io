...
> **译者注：** "roll back"本意为"撤回/推翻"，不译为"撤销"，因为这是前任政府的政策而非特朗普自己的政策，"推翻"更准确。"Undo撤回"是写作过程中的替换思考，确认回退而非撤销。
...
> **译者注：** "At stake"表示强调，意为"关系重大"。"officials in Washington"译为"华盛顿官员"（政治中心代表政府）。"through"在此是"通过（某种手段/方式）"而非"在……领域"，后半句的"particularly through AI"才是领域限定。"cutting China off"补充"获取先进技术"使语义完整。
...
> **译者注：** "persuade"在此语境下译为"游说"或"力劝"比普通的"说服"更有政治游说的意味。"Spur"原意为"马刺"，引申为"刺激、激励"。
...
> **译者注：** "vetted by"译为"经……审查合格"而非"审查的"——"审查的"可能被误解为"正在被审查"。"thoughtful"和"balance"分开翻译更自然："经过深思熟虑，达成了……平衡"作谓语，比"达成了深思熟虑的平衡"更流畅。
...
> **译者注：** "billions"在此语境下译为"数十亿"（不是数千亿）。"racing to"译为"加速/竞相"，中文"争先恐后"也可。"the country's"指"中国的"（非泛指），译为"国内"或直接"中国"。
...
> **译者注：** "Beijing's strategy"在中国语境下译为"中国政府"比直译"北京"更能传达政治主体的含义。在新闻翻译中，"Beijing"常指代中国政府。
...
> **译者注：** "Investor bets"译为"预期"或"押注"均可，前者更偏市场术语。"partly state-backed"译为"国有持股"即可，不必说"部分"。原文"partly"的精准性在中文中偏冗余。
...
> **译者注：** "leading China's race to compete with Nvidia"译为"中国对标英伟达的领军企业"，用"对标"一词准确传达"在追赶竞争中处于领先位置"的双重含义。
...
> **译者注：** "constraints"译为"局限"比"限制"更侧重内在的客观制约。"a think tank"作为同位语，中文可以前置为"美国智库……"，避免在句末赘述。
...
> **译者注：** "TikTok's parent company"作为"ByteDance"的同位语解释，译文中需要保留这一信息，方便国内读者识别字节跳动。
...
> **译者注：** "a mix of"译为"混合使用"——"mixed"作为使用的状语，而非"混合的"的定语。
...
> **译者注：** "taking a cut"译为"抽取回扣"比"抽成"更生动。"kick back"即回扣之意。
